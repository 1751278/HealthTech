...
**Note: There can be conflicts between opencv-python and easyocr's opencv-python-headless** (run this)
```powershell
uv pip uninstall opencv-python opencv-python-headless easyocr
pip install opencv-python easyocr --no-deps
```
